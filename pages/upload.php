...
?>
    <form action="index.php?page=2" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label for="myfile" class="mr-sm-2">Select file for upload:</label>
            <input type="hidden" name="MAX_FILE_SIZE" value="4194304" />
            <input type="file" class="form-control  mb-2 mr-sm-2" name="myfile" accept="image/*">
        </div>
...
<?php
    ...
    if (isset($_POST['uppbtn'])) {
        ...
        echo "<h3/><span style='color:green;'>FileUploaded Successfuly!</span><h3/>";
    }
}
}else{
